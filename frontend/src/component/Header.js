...
import logo from "../assest/mylogo2.png"
...
return (
    <header className='fixed shadow-md w-full h-17 px-2 md:px-4 z-50 bg-white'>
        ...
        <div className='flex items-center h-full justify-between'>
            <Link to={""}>
            <div className='h-16'>
                <img src={logo} className='h-full w-18'/>
            </div>
            </Link>
            ...
            <div className='flex items-center gap-4 md:gap-7'>
                ...
                <div className='text-2xl text-slate-600 relative'>
                    <BsCartFill/>
                    <div className='absolute -top-1 -right-1 text-white bg-red-500 h-4 w-4 rounded-full m-0 p-0 text-sm text-base text-center'>0</div>
                </div>
